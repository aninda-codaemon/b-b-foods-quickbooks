	...
	$xml = '<?xml version="1.0" encoding="utf-8"?>
		...
		<QBXML>
			<QBXMLMsgsRq onError="stopOnError">
				<CustomerAddRq requestID="' . $requestID . '">
					<CustomerAdd>
						<Name>Codaemon Sample Company, LLC (' . mt_rand() . ')</Name>
						<CompanyName>Codaemon Sample Company, LLC</CompanyName>
						<FirstName>Rajib</FirstName>
						<LastName>Naskar</LastName>
						<BillAddress>
							<Addr1>Salt Lake Incubation Center</Addr1>
							<Addr2>Bidhan Nagar</Addr2>
							<City>Kolkata</City>
							<State>WB</State>
							<PostalCode>700019</PostalCode>
							<Country>India</Country>
						</BillAddress>
						<Phone>825-585-1009</Phone>
						<AltPhone></AltPhone>
						<Fax></Fax>
						<Email>rajib.naskar@codaemonsoftwares.com</Email>
						<Contact>Moumita Ray</Contact>
					</CustomerAdd>
				</CustomerAddRq>
			</QBXMLMsgsRq>
		</QBXML>';
